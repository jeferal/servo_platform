...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        x_value = 640 + 250 * math.sin(2 * math.pi * rospy.get_time() / period_time + math.pi / 2)
        y_value = 380 + 250 * math.cos(2 * math.pi * rospy.get_time() / period_time + math.pi / 2) * math.sin(2 * math.pi * rospy.get_time() / period_time + math.pi / 2)
